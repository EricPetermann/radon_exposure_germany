      ...
      column(4,div(p(strong("Indoor radon prediction"),style="font-size:50px;color:#3474A7",class = "verticalcenter")))  #vertical alignment of title??
            ...
            <li>Friedrichstraße 22, 10969 Berlin [Municipality + street + postal code] </li>
                  ...
                  column(4,
                   ...
                   br(),
                   p("This is exclusively supporting material to our paper 'Development of a High-Resolution Indoor Radon Map Using a New Machine Learning-Based Probabilistic Model and German Radon Survey Data' published in Environmental Health Perspectives, Vol 132 (9) in 2024."),
                   br(),  
                   htmlOutput("meinort"),
